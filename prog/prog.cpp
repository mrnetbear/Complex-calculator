...
int main() {
    ...
    cout << "----------Colplex calculator v. 1.0----------" << endl << "Created by A.D. Konotop" << endl << "Tested by:" << endl << "   G.I. Pranovich (PC)" << endl << "   A.D. Konotop (Mac)" << endl << endl << "Released: 23 Nov 2020" << endl << "Last build: 18 Sep 2021" << endl;
    ...
    while (1) {
        ...
        if (oper == "expn" || oper == "root" || oper == "abs"){
            ...
            if (oper == "expn"){
                ...
                u_int expn;
                cout << "Enter root grade: ";
                cin >> expn;
                root(cnum.Re, cnum.Im, expn);
            }
            else if (oper == "abs"){
        ...
        if (oper == "help"){
            cout << endl << "---------------------------------------------" << endl;
            cout << "exit - stop calculations" << endl << "+ - summary" << endl << "- - differ" << endl << "* - product" << endl << "/ - divide" << endl << "abs - absolute z" << endl << "expn - exponentiation" << endl << "root - root of complex number" << endl;
